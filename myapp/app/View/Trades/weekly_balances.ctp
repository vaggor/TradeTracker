...
<div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
          ...
          <div class="">
            <div class="card mg-b-10">
              <div class="card-header pd-t-20 d-sm-flex align-items-start justify-content-between bd-b-0 pd-b-0">
                <div>
                  <h6 class="mg-b-5">Weekly Balances</h6>
                  <p class="tx-13 tx-color-03 mg-b-0">Your Weekly Balances</p>
                </div>
              ...
              <div class="table-responsive">
                <table class="table table-dashboard mg-b-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="tx-color-03 tx-normal"><?php echo $data['Balance']['week']; ?></td>
                      <td class="tx-color-03 tx-normal"><?php echo $data['Balance']['opening_bal']; ?></td>
                      <td class="tx-color-03 tx-normal"><?php echo $data['Balance']['closing_bal']; ?></td>
                      <td class="text-right"><?php echo $data['Balance']['perc_change']; ?>%</td>
                      <td class="text-right"><?php echo $data['Balance']['date']; ?></td>
                      <td class="text-right">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong<?php echo $data['Balance']['id']; ?>">Edit Balance</button>
                      </td>
                    </tr>
      ...
      <!-- Modal -->
<div class="modal fade" id="exampleModalLong<?php echo $data['Balance']['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <?php echo $this->Form->create('Balance',array('url'=>'/trades/weeklyBalances','type'=>'file'));
            echo $this->Form->input('id',array('type'=>'hidden','label'=>false,'value'=>$data['Balance']['id']));
           ?>
           
            <div class="form-group">
              <label for="inputAddress">Week</label>
              <?php echo $this->Form->input('week',array('type'=>'text','label'=>false,'class'=>'form-control','div'=>false,'value'=>$data['Balance']['week'])); ?>
            </div>

            <div class="form-group">
              <label for="inputAddress">Balance</label>
              <?php echo $this->Form->input('closing_bal',array('type'=>'text','label'=>false,'class'=>'form-control','div'=>false,'value'=>$data['Balance']['closing_bal'])); ?>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <?php echo $this->Form->create('Balance',array('url'=>'/trades/weeklyBalances','type'=>'file')); ?>
            ...
            <div class="form-group">
              <label for="inputAddress">Week</label>
              <?php echo $this->Form->input('week',array('type'=>'text','label'=>false,'class'=>'form-control','div'=>false,'placeholder'=>'Week')); ?>
            </div>
