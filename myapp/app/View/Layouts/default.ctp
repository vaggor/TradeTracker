    ...
    <header class="navbar navbar-header navbar-header-fixed">
      ...
      <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
          ...
          <li class="nav-item">
            <?php echo $this->Html->link('<i data-feather="box"></i> Dashboard',array('controller'=>'trades','action'=>'dashboard'),array('class'=>'nav-link','escape'=>false)); ?>
          </li>
          <li class="nav-item">
            <?php echo $this->Html->link('<i data-feather="box"></i> Accounts',array('controller'=>'trades','action'=>'accounts'),array('class'=>'nav-link','escape'=>false)); ?>
          </li>
          <li class="nav-item with-sub">
            <a href="#" class="nav-link"><i data-feather="pie-chart"></i> Trades</a>
            <ul class="navbar-menu-sub">
              <li class="nav-sub-item">
                 <?php echo $this->Html->link('<i data-feather="bar-chart-2"></i> Open Trades',array('controller'=>'trades','action'=>'entries',0),array('class'=>'nav-sub-link','escape'=>false)); ?>
              </li>
              <li class="nav-sub-item">
                 <?php echo $this->Html->link('<i data-feather="bar-chart-2"></i> Closed Trades',array('controller'=>'trades','action'=>'entries',1),array('class'=>'nav-sub-link','escape'=>false)); ?>
              </li>
              <li class="nav-sub-item">
                 <?php echo $this->Html->link('<i data-feather="bar-chart-2"></i> All Trades',array('controller'=>'trades','action'=>'entries'),array('class'=>'nav-sub-link','escape'=>false)); ?>
              </li>
            </ul>
          </li>
          <li class="nav-item">
            <?php echo $this->Html->link('<i data-feather="box"></i> Balances',array('controller'=>'trades','action'=>'weeklyBalances'),array('class'=>'nav-link','escape'=>false)); ?>
          </li>
          <li class="nav-item">
